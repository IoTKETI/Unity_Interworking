...
1. Download and decompress the zip file from Releases on the right. https://github.com/IoTKETI/Unity_Interworking/releases
...
## 사전 설치
1. 우측의 Releases에서 zip 파일을 다운로드 및 압축 해제합니다. https://github.com/IoTKETI/Unity_Interworking/releases
